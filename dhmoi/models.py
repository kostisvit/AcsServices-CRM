...
class Service(models.Model):
    ...
    cost = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name='Κόστος', null=False, blank=False)
...
class Ergasies(models.Model):
    ...
    name = models.CharField(max_length=100, verbose_name='Υπάλληλος Επικοιν.', null=True, help_text='Επώνυμο-Όνομα',
                            blank=True)
...
class Adeia(models.Model):
    ...
    adeiatype = models.CharField(max_length=50, choices=adeia_choice, verbose_name='Τύπος Άδειας', blank=True,
                                 default='-')
...
class Polisi(models.Model):
    ...
    sinoltimi = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Συνολική τιμή', null=False,
                                    blank=False, default='0')
    katagrafi = models.DateField(
        default=datetime.date.today, verbose_name='Καταγραφή')
    etos = models.PositiveIntegerField(
        default=current_year(), verbose_name='Έτος')
    status = models.CharField(max_length=50, verbose_name='Status', null=False, blank=False, choices=polisi_choice,
                              default='OPEN')
